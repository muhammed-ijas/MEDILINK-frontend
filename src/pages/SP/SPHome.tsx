  ...
  return (
    <div>
        ...
        <div className="flex flex-col md:flex-row h-full relative">
          ...
          <div className="relative md:w-1/2 h-full flex flex-col justify-center items-center text-center p-6 md:p-10">
            ...
            >
              ...
              >
                At MediLink, we recognize the importance of delivering quality healthcare services to those who need them most. Our platform is dedicated to supporting service providers like you by offering a comprehensive solution to connect with a wider audience.
              </motion.p>

              <div className="flex flex-col gap-4">
                <motion.button
                  onClick={handleServices}
                  className="w-full md:w-auto border border-gray-400 text-white font-semibold py-2 px-4 rounded-lg mb-4 hover:bg-white hover:text-blue-950 transition-colors duration-300"
                  whileHover={{
                    scale: 1.05,
                  }}
      ...
      <div className="p-10 justify-center text-center mt-8">
        <h1 className="text-4xl font-bold text-blue-950">Our Services</h1>
      </div>
      <section className="p-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Hospital Card */}
          <div className="service-card  p-6 rounded-lg shadow-md flex flex-col  hover:shadow-2xl items-center transform transition-transform hover:scale-105 bg-white text-blue-950  ">
            <img
              src={hospitalImage}
          ...
          {/* Home Nursing Card */}
          <div className="service-card  p-6 rounded-lg shadow-md  hover:shadow-2xl flex flex-col items-center transform transition-transform hover:scale-105  bg-white text-blue-950 ">
            <img
              src={homenurseImage}
      ...
      <section className="p-8 bg-white text-center text-blue-950">
        ...
        <p className="mt-4 text-blue-500 hover:underline">
          <a href="/sp/contact">Contact Page</a>
        </p>
      </section>
